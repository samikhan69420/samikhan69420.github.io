...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1266: x0 => new Event(x0),
      _1267: (x0,x1) => x0.dispatchEvent(x1),
      _1268: (x0,x1,x2) => new ShadcnAppTheme(x0,x1,x2),
      _1269: x0 => new ShadcnAppThemeChangedEvent(x0),
      _1270: x0 => x0.globalThis,
      _1271: (x0,x1) => x0.shadcnAppLoaded = x1,
      _1272: x0 => x0.ShadcnApp,
      _1273: () => globalThis.window,
      _1283: x0 => x0.load(),
      _1284: x0 => x0.play(),
      _1285: x0 => x0.pause(),
      _1286: x0 => x0.preventDefault(),
      _1289: (x0,x1) => x0.removeAttribute(x1),
      _1291: (x0,x1) => x0.start(x1),
      _1292: (x0,x1) => x0.end(x1),
      ...
      _1469: (x0,x1) => x0.controlsList = x1,
      _1481: (s, m) => {
        try {
      ...
      _1726: x0 => x0.style,
      _2298: x0 => x0.videoWidth,
      _2299: x0 => x0.videoHeight,
      _2303: (x0,x1) => x0.playsInline = x1,
      _2328: x0 => x0.error,
      _2330: (x0,x1) => x0.src = x1,
      _2339: x0 => x0.buffered,
      _2342: x0 => x0.currentTime,
      _2343: (x0,x1) => x0.currentTime = x1,
      _2344: x0 => x0.duration,
      _2349: (x0,x1) => x0.playbackRate = x1,
      _2356: (x0,x1) => x0.autoplay = x1,
      _2358: (x0,x1) => x0.loop = x1,
      _2360: (x0,x1) => x0.controls = x1,
      _2362: (x0,x1) => x0.volume = x1,
      _2364: (x0,x1) => x0.muted = x1,
      _2379: x0 => x0.code,
      _2380: x0 => x0.message,
      _2453: x0 => x0.length,
      _2956: x0 => x0.src,
      _2957: (x0,x1) => x0.src = x1,
      _2959: (x0,x1) => x0.type = x1,
      _2963: (x0,x1) => x0.async = x1,
      _2977: (x0,x1) => x0.charset = x1,
      _3426: () => globalThis.window,
      _3488: x0 => x0.navigator,
      ...
      _10700: (x0,x1) => x0.border = x1,
      _11142: (x0,x1) => x0.height = x1,
      _11832: (x0,x1) => x0.width = x1,
      _12200: x0 => x0.name,
...
"Socials",
"Github",
"github.com/samikhan69420",
"https://github.com/samikhan69420",
"RadixIcons",
"LinkedIn",
"linkedin.com/in/samikhan69420/",
"https://linkedin.com/in/samikhan69420/",
"Mail",
"samikhan69420@gmail.com",
"mailto:samikhan69420@gmail.com",
"antiAlias",
"DragStartBehavior.",
...
"2013 - 2021",
"The Educators",
"9th Class - 11th Class",
"2021 - Current",
"Hazara School and College",
"My Projects",
"Passman",
"Passman is an AI password manager that can generate passwords with AI which makes the passwords more memorable",
"assets/passman/profile.png",
"assets/passman/passwords.png",
"assets/passman/ai_password.png",
"assets/passman/preview1.gif",
"assets/passman/preview2.gif",
"github.com/samikhan69420/ai_password_manager",
"Follow Flow",
"This was actually one of my first flutter projects, I have been working on it ever since, you can buy followers for instagram and other social medias",
"assets/follow_flow/login.gif",
"assets/follow_flow/order.gif",
"assets/follow_flow/add_coin.gif",
"Chacha Caller",
"This app uses Firebase database and OneSignal API for sending notifications to office/house workers to call them to your room.",
"assets/chacha_caller/login.png",
"assets/chacha_caller/signup.png",
"assets/chacha_caller/mainpage.png",
"assets/chacha_caller/preview.gif",
"Foodprime",
"This was more of a pratice project which I made to showcase my UI and Animations skills.",
"assets/foodprime/foodprime.mp4",
"AI Chat and Image Generation",
"This app uses google's Gemini and Image Pollinations to generate text and images efficiently",
"assets/ai_chat_img/chat.png",
"assets/ai_chat_img/img.png",
"assets/ai_chat_img/app_preview.mp4",
"network",
"contentUri",
"videoEventsFor() has not been implemented.",
"setWebOptions() has not been implemented.",
"controlsList",
...
"video",
"setMixWithOthers() has not been implemented.",
...
"I have over 1.5 years of experience with Flutter",
"2.5 years of experience with object oriented programming",
"I code apps using Clean architecture.",
"I have integrated AI into multiple apps.",
"With Flutter's cool Framework, I can add subtle or major animations to UI.",
"◦  ",
"Axis.",
"onDrag",
...
"Drag a block to the right side",
"measureCross",
"measureMain",
